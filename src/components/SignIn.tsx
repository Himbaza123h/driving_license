      ...
      <div className="mt-6">
        ...
        {onSwitchToNationalId && (
          <button
            ...
            disabled={isLoading}
            className="w-full mt-3 bg-white hover:bg-gray-50 text-green-600 font-bold py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-3 shadow-md disabled:opacity-50 disabled:cursor-not-allowed font-inter"
          >
            <span>Login with MOSIP</span>
